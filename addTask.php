<?php
    ...
    if (isset($userName)) { 
        $welcomeMessage = "<h3>Add a Task | <a href='addRecord.php'>Add Project</a> | <a href='welcome.php'>Home</a></h3>";
    }
...
<html>
    ...
    <footer id=footer class="w3-container w3-center w3-text-gray">&copy; <?php echo $curYear; ?> Edward Prenzler | TaskList </footer>
    <style>
    body{
